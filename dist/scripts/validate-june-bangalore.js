...
for (let day = 1; day <= 30; day++) {
    ...
    const p = (0, index_1.getPanchangam)(date, observer);
    const tithi = String(index_1.tithiNames[p.tithi] || p.tithi);
    const nakshatra = String(index_1.nakshatraNames[p.nakshatra] || p.nakshatra);
    const yoga = String(index_1.yogaNames[p.yoga] || p.yoga);
...
//# sourceMappingURL=validate-june-bangalore.js.map