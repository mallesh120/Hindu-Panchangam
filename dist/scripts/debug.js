...
const observer = new astronomy_engine_1.Observer(observerInfo.latitude, observerInfo.longitude, observerInfo.elevation);
const tithiNames = [
...
function debugTithiCalculation(date) {
    console.log(`\n=== DEBUG TITHI CALCULATION FOR ${luxon_1.DateTime.fromJSDate(date).toFormat('yyyy-MM-dd HH:mm')} ===`);
...
const bangaloreObserver = new astronomy_engine_1.Observer(12.9716, 77.5946, 920);
const today = new Date();
const panchangam = (0, index_1.getPanchangam)(today, bangaloreObserver);
